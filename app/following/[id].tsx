...
export default function Following() {
  ...
  const [userData, setUserData] = useState({ name: '', email: '', avatar: '', bio: '', Following: []});
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const followingDetailsPromises = detailsDoc.following.map(async (email) => {
        ...
        setFollowingDetails(followingDetails);
      } catch (error) {
